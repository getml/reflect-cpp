...
Vcpkg is used to manage dependencies (except for JSON). If you need features other than the out-of-the-box JSON support, you need to bootstrap vcpkg first:
...
Use reflect-cpp in your project:
