...
- [**Easily Extensible:**](https://rfl.getml.com/concepts/structs.md) Supports additional serialization formats and [custom classes](https://rfl.getml.com/concepts/custom_classes.md).
