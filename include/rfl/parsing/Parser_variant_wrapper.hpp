#ifndef RFL_PARSING_PARSER_VARIANTWRAPPER_HPP_
#define RFL_PARSING_PARSER_VARIANTWRAPPER_HPP_
...
requires AreReaderAndWriter<R, W, VariantWrapper<VariantType>>
class Parser<R, W, std::variant<AlternativeTypes...>, ProcessorsType> {
 public:
  using InputVarType = typename R::InputVarType;

  template <bool _wrap_variant = false>
  static Result<VariantWrapper<VariantType>> read(
  ...
  template <class P>
  static void write(const W& _w, const VariantWrapper<VariantType>& _variant,
