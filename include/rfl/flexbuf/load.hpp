...
/// Loads an object from a FlexBuffers file.
/// Reads a binary file from disk and parses its FlexBuffers content into a C++ object using compile-time reflection.
...
/// @param _fname The filename/path of the FlexBuffers file to load
